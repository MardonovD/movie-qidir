...
const valueControl = function() {
    const inp = document.querySelector(".movie__value");
    const value = inp.value;
    console.log(value);
};
valueControl();
document.addEventListener("keydown", function(e) {
    if (e.keyPres == 13) console.log(45);
});
...
const api = async function(value) {
    const api1 = await fetch(`https://omdbapi.com/?s=${apiName}&page=1&apikey=fc1fef96`);
...
},{}]},["7yNqf","bznnK"], "bznnK", "parcelRequireef5b")
